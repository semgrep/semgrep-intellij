...
class ScanWorkspaceNotification(private val server: com.semgrep.idea.lsp.SemgrepLspServer, private val params: ScanWorkspaceParams): LspClientNotification(server){
